import { MessageBrokerRabbitPublisherConfigInterface } from "../../infrastructure/message-brokers/message-broker-rabbitmq.interface";
import MessageBrokerRabbitMqPublisher from "../../infrastructure/message-brokers/message-broker-rabbitmq.publisher";
...
export default () => new MessageBrokerRabbitMqPublisher(makeMessageBrokerHelper(), config);